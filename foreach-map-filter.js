...
function showFirstAndLast(arr){
    ...
    arr.forEach(function(word){
        ...
        newArray.push(firstChr + lastChr);
...
function removeVowels(str) {
    ...
    let noVowelsString = lowerCasedString.split("").filter(function(val) {
      return vowels.indexOf(val) === -1;
    })
    let newString = noVowelsString.join("");
    return newString;
}
...
function doubleOddNumbers(arr) {
    ...
    let newArray = oddNum.map(function(val) {
      return val * 2;
    });
    return newArray; 
}
